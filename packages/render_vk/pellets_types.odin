...
Pellets_Gpu_State :: struct {
	grid_clear_shader, grid_populate_shader, grid_prefix_shader, grid_prefix_blocks_shader, grid_prefix_add_shader, grid_scatter_shader, physics_shader, density_shader: engine.Vk_Shader_Module,
	...
	grid_clear_pipeline, grid_populate_pipeline, grid_prefix_pipeline, grid_prefix_blocks_pipeline, grid_prefix_add_pipeline, grid_scatter_pipeline, physics_pipeline, density_pipeline: engine.Vk_Compute_Pipeline,
	...
	grid_clear_set_layout, grid_populate_set_layout, grid_prefix_set_layout, grid_scatter_set_layout, physics_set_layout, density_set_layout: vk.DescriptorSetLayout,
	background_set_layout, render_set_layout, trail_fade_set_layout, trail_blit_set_layout: vk.DescriptorSetLayout,
	descriptor_pool: vk.DescriptorPool,
	grid_clear_sets, grid_populate_sets, grid_prefix_sets, grid_scatter_sets, physics_sets, density_sets: [engine.MAX_FRAMES_IN_FLIGHT]vk.DescriptorSet,
	...
	physics_params_buffers, density_params_buffers: [engine.MAX_FRAMES_IN_FLIGHT]engine.Vk_Buffer,
