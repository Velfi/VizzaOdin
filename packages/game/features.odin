...
FEATURE_ID_ST_FLIP         :: Feature_Id(0x5649_000b)
...
FEATURE_DESCRIPTORS := [?]Feature_Descriptor {
	...
	{FEATURE_ID_ST_FLIP, .ST_FLIP, "ST-FLIP", "Spatiotemporal liquid", {.Simulation, .Live_Preview, .Video_Capture, .Scene_Post_Processing}, {192, 128, 1}, size_of(ST_Flip_Settings), align_of(ST_Flip_Settings), feature_defaults_st_flip, feature_settings_validate_st_flip, feature_settings_copy_bytes, size_of(ST_Flip_Runtime_State), align_of(ST_Flip_Runtime_State), feature_runtime_initialize_st_flip, nil, feature_color_access_st_flip, feature_apply_builtin_st_flip, feature_apply_settings_st_flip, feature_reset_st_flip, feature_preset_load_st_flip, feature_preset_save_st_flip, feature_update_st_flip, {}, 0, feature_builtin_presets_st_flip, feature_apply_input_st_flip, feature_draw_ui_st_flip, feature_set_paused_st_flip, feature_lifecycle_enter_noop, feature_lifecycle_leave_st_flip, feature_draw_controls_st_flip},
