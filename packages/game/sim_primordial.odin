...
primordial_draw_ui_overlay :: proc(vk_ctx: ^engine.Vk_Context, frame: engine.Vk_Frame, ui: ^engine.Ui_Renderer) {
	if ui == nil {
		return
	}
...
primordial_gpu_present :: proc(gpu: ^Primordial_Gpu_State, vk_ctx: ^engine.Vk_Context, frame: engine.Vk_Frame, sim: ^Remaining_Sim_State, ui: ^engine.Ui_Renderer = nil) {
	if !gpu.ready {
