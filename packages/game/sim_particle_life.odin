...
particle_life_draw_controls :: proc(sim: ^Particle_Life_Simulation, ctx: ^uifw.Gui_Context, panel: uifw.Rect, scroll: ^f32, worker: ^Render_Worker_State, color_editor: ^Color_Scheme_Editor_State, section := -1) {
