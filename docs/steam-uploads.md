...
2. Name them something like `Vizza Windows` and `Vizza macOS`.
3. Set **Operating System** to **Windows** and **macOS**, respectively.
4. Leave **For DLC** as **Base App**.
5. Save changes.
6. Add both depots to every package that should install the game, at
